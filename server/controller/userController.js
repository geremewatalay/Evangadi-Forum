...
async function register(req,res) {
    ...
    if (!email|| !password|| !firstname || !lastname || !username){
        return res.status(StatusCodes.BAD_REQUEST).json({msg:"please provide all required field"})
    }
    try {
        ...
        return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({msg:"something wen wrong,try again later!"})    
    }  
}
